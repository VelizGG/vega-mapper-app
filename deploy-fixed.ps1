...
try {
    $repoCheck = gh repo view VelizGG/vega-mapper-app 2>&1
...
try {
    ...
    if ($LASTEXITCODE -ne 0) {
        ...
        Write-Host "✅ Remote origin ya configurado: $remoteCheck" -ForegroundColor Green
    }
} catch {
...
- Interactive data visualization tool using Vega-Lite
